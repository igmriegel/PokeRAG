...
│   ├── REQUIREMENTS.md                 # Traceable requirements matrix (REQ-001 to REQ-030)
...
├── 02_sprints/                         # Objective Sprint Specs (Sprints 1-8)
...
│   ├── TASK_INDEX.md                   # Master index of granular tasks (TASK-001 to TASK-032)
