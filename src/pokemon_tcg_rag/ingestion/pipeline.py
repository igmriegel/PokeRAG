...
class IngestionPipeline:
    ...
    def run(
        ...
        collection_metadata = self._persist_chunk_documents(chunks)
        ...
        if index:
            seed_chunks(chunks, collection_metadata=collection_metadata)
            LOGGER.info(
                "ingestion_finished",
    ...
    def _persist_chunk_documents(self, chunks: list[Chunk]) -> dict[str, object]:
        ...
        manifest = CorpusManifest(
            ...
            version=get_settings().CORPUS_VERSION,
            description="Official Pokemon TCG rules corpus generated by the ingestion pipeline.",
        ...
        manifest_path = self.chunks_dir / "corpus_manifest.json"
        ...
        return manifest.to_collection_metadata()
